...
function (angular, app, _, PanelMeta) {
  ...
  var module = angular.module('grafana.panels.raintankEndpointNavPanel',  []);
  app.useModule(module);
  module.directive('grafanaPanelRaintankendpointnavpanel', function() {
    return {
      controller: 'raintankEndpointNavPanel',
      templateUrl: 'plugins/raintank/panels/raintankEndpointNavPanel/module.html',
    };
  });

  module.controller('raintankEndpointNavPanel', function($scope, $http, $location, $rootScope, $q, backendSrv, panelSrv) {
    $scope.panelMeta = new PanelMeta({
      panelName: 'Raintank Endpoint Nav Panel',
      description : "Endpoint Nav Panel",
      fullscreen: false
    });
    $scope.panel.title = "";
    $scope.panel.transparent = true;
